...
import { FormProvider, useForm } from "react-hook-form"; // ← CORRECCIÓN AQUÍ
...
export function LoginForm() {
  ...
  return (
    <Card className="w-full max-w-md shadow-xl bg-card/90 backdrop-blur-sm border-primary/20">
      <CardHeader>
        <CardTitle className="text-3xl font-bold text-center text-primary text-glow-primary">
          Welcome Back!
        </CardTitle>
      ...
      <CardContent>
        {/* ← Aquí envolvemos con FormProvider */}
        <FormProvider {...form}>
          {/* El <form> sólo lleva onSubmit, no props RHF directos */}
